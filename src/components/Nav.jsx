  ...
  return (
    <header>
      <nav id="nav" class="w-full md:h-16">
        ...
        >
          <NavItem icon="bi bi-house-heart" text="Home " url="/PinguBot-WebPage" />
          <NavItem icon="bi bi-journal" text="Blog " url="/PinguBot-WebPage/blog" />
          <NavItem icon="bi bi-robot" text="Project " url="/PinguBot-WebPage/project" />
        </div>
      </nav>
    </header>
  );
